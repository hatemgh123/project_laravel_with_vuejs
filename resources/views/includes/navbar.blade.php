<nav class="navbar navbar-expand-md navbar-light navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
           ...
           <img src="{{ asset('images/title-logo.png') }}" style="    height: 36px;">
        </a>
...
<div class="btn-group" style="    margin-top: 9px;">
    <a  id="navbarDropdown"  href="#" style="    font-size: 25px;
    color: #3490dc;" class="fas fa-bell nav-link  " data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
